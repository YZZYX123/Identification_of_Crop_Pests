...
# from resnet.resnet_simple import resnet50
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='CropNet', type=str, metavar='MODEL',
    ...
    parser.add_argument('--teacher-model', default='biformer_small_best', type=str, metavar='MODEL',
    ...
    # * Finetuning params
    parser.add_argument('--finetune', default='/home/zoujixiang/Pest_Recognition-main-test/pre_train/biformer_base_best.pth',
                        help='finetune from checkpoint')

    # Dataset parameters
    parser.add_argument('--data-path', default='/home/zoujixiang/Pest_Recognition-main-test/IP102', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--log_dir', default='./Output1/log',
...
def main(args):
    ...
    for k in ['fc.weight', 'fc.bias','conv1.weight']:
